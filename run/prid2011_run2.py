...
def main(dataset_folder, data_npz_file, epoch_train=100, batch_size=8, snippet_len=8, snippet_stride=3,
         model_folder=".", model_file="none.pth", split_id=0):
    ...
    for epoch_id in range(epoch_train):
        ...
        if first_run_check_top_k:
            ...
            print("before training, top-k: %s" % mean_top_k)
...
if __name__ == '__main__':
    ...
    #      model_folder="/home/haofeng/Desktop/saved_models/prid2011_src_split0", split_id=0)

    main(dataset_folder="/home/haofeng/Desktop/datasets/dst/prid_2011/pose",
         data_npz_file="/home/haofeng/Desktop/datasets/dst/prid_2011/pose_array.npz",
         epoch_train=10, batch_size=8, snippet_len=8, snippet_stride=3,
         model_folder="/home/haofeng/Desktop/saved_models/prid2011_pose_split0/", split_id=0)
